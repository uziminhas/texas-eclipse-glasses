      ...
      compoundVariants: [
        {
          color: 'primary',
          variant: 'normal',
          className: `bg-red-600 dark:focus:ring-primary-500/70 text-primary-contrast hover:bg-blue-700 active:bg-primary-700 dark:text-primary-contrast`,
        },
        {
          color: 'danger',
          variant: 'normal',
        ...
        },
        {
          color: 'primary',
          variant: 'flat',
          className: `bg-blue-600 dark:focus:ring-red-700 text-primary-contrast hover:bg-red-600 active:bg-primary-700 dark:text-primary-contrast`,
        },
        {
          color: 'danger',
          variant: 'flat',
